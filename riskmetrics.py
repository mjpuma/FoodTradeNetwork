...
def plot_time_series_countries(data, countries, output_directory):
    ...
    plt.tight_layout()
    save_path = os.path.join(output_directory, 'time_series_GPRHC_countries.png')
    plt.savefig(save_path)
    plt.close()
